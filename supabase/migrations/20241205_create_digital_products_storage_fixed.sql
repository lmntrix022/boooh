-- Migration corrigée pour créer le stockage des produits numériques
-- Date: 2024-12-05
-- Évite les erreurs de permissions sur storage.objects
...
-- 9. Index pour optimiser les requêtes
...
-- 10. Vue pour les statistiques de stockage par utilisateur
