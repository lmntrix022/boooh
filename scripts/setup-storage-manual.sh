...
# Script pour configurer le stockage manuellement via l'interface Supabase
# Date: 2024-12-05

echo "🔧 Configuration manuelle du stockage des produits numériques..."
...
print_status "Application de la migration corrigée..."

# Appliquer la migration corrigée
if supabase db push --file supabase/migrations/20241205_create_digital_products_storage_fixed.sql; then
    print_success "Migration corrigée appliquée avec succès"
else
...
echo ""
echo "🔐 POLITIQUES RLS À CONFIGURER :"
echo ""
...
echo "  ✅ Migration corrigée appliquée"
